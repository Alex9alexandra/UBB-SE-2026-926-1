...
namespace ChatModule.src.HttpService
{
    public class AttendedEventHttpService : IAttendedEventService
    {
        ...
        {
            var events = await _httpClient.GetFromJsonAsync<List<AttendedEvent>>(
                $"api/AttendedEvents/{userId}");
        ...
        {
            var events = await _httpClient.GetFromJsonAsync<List<AttendedEvent>>(
                $"api/AttendedEvents/{userId}/archived?isArchived={isArchived}");
        ...
        public async Task<AttendedEvent?> GetAsync(int eventId, Guid userId)
        {
            var response = await _httpClient.GetAsync(
                $"api/AttendedEvents/{eventId}/{userId}");
        ...
        public async Task AttendEventAsync(int eventId, Guid userId)
        {
            var response = await _httpClient.PostAsync(
                $"api/AttendedEvents/{eventId}/{userId}/attend",
                null);
        ...
        public async Task LeaveEventAsync(int eventId, Guid userId)
        {
            var response = await _httpClient.DeleteAsync(
                $"api/AttendedEvents/{eventId}/{userId}/leave");
        ...
        public async Task SetArchivedAsync(int eventId, Guid userId, bool isArchived)
        {
            var response = await _httpClient.PutAsync(
                $"api/AttendedEvents/{eventId}/{userId}/archive?isArchived={isArchived}",
                null);
        ...
        {
            var response = await _httpClient.PutAsync(
                $"api/AttendedEvents/{eventId}/{userId}/favourite?isFavourite={isFavourite}",
                null);
        ...
        {
            var events = await _httpClient.GetFromJsonAsync<List<AttendedEvent>>(
                $"api/AttendedEvents/{userId}/common/{friendId}");
